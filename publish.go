...
func PublishWithAutoGeneratedMetadata(videoPath, hashtags, platforms string) error {
	...
	err = PublishVideo(videoPath, selectedTitle, description, hashtags, platforms)
	if err != nil {
...
// PublishVideo handles uploading a video to multiple platforms, including YouTube.
func PublishVideo(videoPath, title, description, hashtags, platforms string) error {
	...
	for _, platform := range platformList {
		...
		switch platform {
			case "youtube":
				...
				// Upload video using Media option
				call := service.Videos.Insert([]string{"snippet", "status"}, video)
				call.Media(fileBuffer) // Use buffered file for upload
		...
		if err != nil {
			log.Printf("❌ Failed to upload to %s: %v", platform, err)
		} else {
